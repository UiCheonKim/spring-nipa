...
import dz.nft.nipa.utils.Base64EncodeingUtil;
import dz.nft.nipa.utils.HashStringUtil;
import dz.nft.nipa.utils.SendBase64File2BlockchainApi;
import dz.nft.nipa.utils.SendUserId2BlockchainApi;
import dz.nft.nipa.utils.UnixTimeUtil;
...
public class AdminServiceImpl implements AdminService {
	...
	public void insertNftData(DataNftDto dto, String token) throws IOException {
		...
		new SendBase64File2BlockchainApi().sendData(requestMap, token);
